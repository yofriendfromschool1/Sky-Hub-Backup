...
MainSection:NewButton("Infinite Stamina", "stamina set to 9999", function()
...
MainSection:NewDropdown("Emote selector", "selects the emote you want to use", {
	...
	local danceTrack 
	if currentoption == "Griddy" then
		danceTrack = game:GetService("Players").LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid"):LoadAnimation(game:GetService("ReplicatedStorage").Assets.Emotes.Griddy):Play()
		danceTrack.Looped = true
		danceTrack:Play()
	elseif currentoption == "L" then
		danceTrack = game:GetService("Players").LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid"):LoadAnimation(game:GetService("ReplicatedStorage").Assets.Emotes.L):Play()
		danceTrack.Looped = true
		danceTrack:Play()
	elseif currentoption == "Laugh" then
		danceTrack = game:GetService("Players").LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid"):LoadAnimation(game:GetService("ReplicatedStorage").Assets.Emotes.Laugh):Play()
		danceTrack.Looped = true
		danceTrack:Play()
	elseif currentoption == "Sit" then
		danceTrack = game:GetService("Players").LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid"):LoadAnimation(game:GetService("ReplicatedStorage").Assets.Emotes.Sit):Play()
		danceTrack.Looped = true
		danceTrack:Play()
	elseif currentoption == "Cross Legs" then
		danceTrack = game:GetService("Players").LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid"):LoadAnimation(game:GetService("ReplicatedStorage").Assets.Emotes.CrossLegs):Play()
		danceTrack.Looped = true
		danceTrack:Play()
	elseif currentoption == "Cry" then
		danceTrack = game:GetService("Players").LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid"):LoadAnimation(game:GetService("ReplicatedStorage").Assets.Emotes.Cry):Play()
		danceTrack.Looped = true
		danceTrack:Play()
	elseif currentoption == "Floss" then
		danceTrack = game:GetService("Players").LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid"):LoadAnimation(game:GetService("ReplicatedStorage").Assets.Emotes.Floss):Play()
		danceTrack.Looped = true
		danceTrack:Play()
	elseif currentoption == "Stop Emoting" then
		local hum = game:GetService("Players").LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid") or game:GetService("Players").LocalPlayer.Character:FindFirstChildWhichIsA("AnimationController")
...
MainSection:NewToggle("Hide for dropper", "makes you go super high so they dont see you and choose you", function(state)
	local ogpos = game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame
	local oggravity = game:GetService("Workspace").Gravity
	while state do 
		task.wait()
		game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = CFrame.new(0, 1000, 0)
		game:GetService("Workspace").Gravity = 0
		if not state then
			game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").CFrame = ogpos
			game:GetService("Workspace").Gravity = oggravity
		end
	end
end)

MainSection:NewToggle("Loop Auto Win Duel", "makes you automatically win duels", function(state)
	while state do 
		task.wait()
		if game:GetService("Workspace").Duel["wall light"]:WaitForChild("light").Color ~= Color3.fromRGB(202, 78, 80) then
			Library.Notify("SHOOT", "SHOOT bc this isnt finished yet so do it urself", 5)
		end
	end
end)
