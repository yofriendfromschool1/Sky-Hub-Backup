...
MainSection:NewButton("Dusk and shine", "only thing that works for this shitty game", function()
	loadstring(game:HttpGet("https://duskandshine.xyz/raw/DuskLastVer"))()
end)
