...
local SilentAimGroupBox = AimingTab:AddRightTabbox("Player")
local FlightTab = SilentAimGroupBox:AddTab("Flight")
local PlayerTab = SilentAimGroupBox:AddTab("Player")

FlightTab:AddToggle("Flight GUI", {
    Values = FlightTab,
    Text = "Fly GUI",
    Callback = function()
